...
def build_master_games(espn_games: pd.DataFrame, hoopr_box: pd.DataFrame) -> pd.DataFrame:
    ...
    NON_D1_KEYWORDS = [
        ...
        "lincoln_university__ca_", "noble", "nobel", "naia", "juco", "community_college",
        "bible", "seminary", "christian_college", "east_west_university", "shenango",
        "toccoa", "fisk", "cleary", "lincoln_university__ca", "oaklanders",
        "penn_state_shenango", "virginia_lynchburg",
    ]
